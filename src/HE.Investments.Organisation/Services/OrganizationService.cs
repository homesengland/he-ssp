...
public class OrganizationService : IOrganizationService
{
    ...
    {
        var organisationChangeDetailsRequest = await _organisationChangeRequestRepository.GetChangeRequestForOrganisation(_service, accountId.TryToGuidAsString());
    ...
    public async Task<OrganizationDetailsDto> GetOrganizationDetails(string accountId, string contactExternalId)
    {
        ...
        accountId = accountId.TryToGuidAsString();
    ...
    private static Entity MapOrganizationDtoToOrganizationChangeRequestEntity(OrganizationDetailsDto organizationDetailsDto)
    {
        var organisationChangeRequestEntity = new Entity("invln_organisationchangerequest")
        {
            Attributes = new AttributeCollection()
            {
                ...
                { "invln_organisationid", new EntityReference(AccountEntity.Name, new Guid(organizationDetailsDto.organisationId.TryToGuidAsString())) },
            },
        };
