...
{
    public static readonly DateTime SeptemberDay20Year2023At0736 = new(2023, 9, 20, 7, 36, 0, 0, DateTimeKind.Utc);

    public static readonly DateTime OctoberDay05Year2023At0858 = new(2023, 10, 5, 8, 58, 0, 0, DateTimeKind.Utc);
