    ...
    public class GdsH2AppTaskListTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            if (output != null)
            {
                ...
                TagConstruct.ConstructClass(output, CssConstants.GovUkAppTaskListSection);
