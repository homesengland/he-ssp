...
{
    /// <summary>
    /// Class GdsSpanAppListSectionTagHelper.
    /// Implements the <see cref="Microsoft.AspNetCore.Razor.TagHelpers.TagHelper" />.
    /// </summary>
    /// <seealso cref="Microsoft.AspNetCore.Razor.TagHelpers.TagHelper" />
    public class GdsSpanAppListSectionTagHelper : TagHelper
    {
        /// <summary>
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            if (output != null)
            {
                ...
                TagConstruct.ConstructClass(output, CssConstants.GovUkAppTaskListSectionNumber);
