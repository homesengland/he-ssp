...
{
    /// <summary>
    /// Class GdsSummaryListActionTagHelper.
    /// Implements the <see cref="Microsoft.AspNetCore.Razor.TagHelpers.TagHelper" />.
    /// </summary>
    /// <seealso cref="Microsoft.AspNetCore.Razor.TagHelpers.TagHelper" />
    public class GdsSummaryListActionsTagHelper : TagHelper
    {
        /// <summary>
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            if (output != null)
            {
                output.TagName = HtmlConstants.Summary;
                TagConstruct.ConstructId(output, this.Id);
                TagConstruct.ConstructClass(output, CssConstants.GovUkSummaryListActions);
