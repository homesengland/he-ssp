    ...
    public class GdsRadioLabelTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            if (output != null)
            {
                ...
                TagConstruct.ConstructClass(output, $"{CssConstants.GovUkLabel} {CssConstants.GovUkRadiosLabel}");
