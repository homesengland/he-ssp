...
namespace He.AspNetCore.Mvc.Gds.Components.TagHelpers.Lists
{
    ...
    public class GdsOlAppTaskListTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            if (output != null)
            {
                output.TagName = HtmlConstants.Ol;
                TagConstruct.ConstructClass(output, CssConstants.GovUkAppTaskList);
