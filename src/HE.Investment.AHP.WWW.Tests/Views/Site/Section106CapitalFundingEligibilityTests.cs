...
public class Section106CapitalFundingEligibilityTests : ViewTestBase
{
    ...
    public async Task ShouldDisplayView()
    {
        ...
        document
            ...
            .HasGdsRadioInputWithValues(nameof(Section106.CapitalFundingEligibility), "True", "False")
    ...
    public async Task ShouldErrorSummary_ForInvalidName()
    {
        ...
        var section106 = new Section106(_siteId, _siteName, null);
        modelState.AddModelError(nameof(Section106.CapitalFundingEligibility), errorMessage);
