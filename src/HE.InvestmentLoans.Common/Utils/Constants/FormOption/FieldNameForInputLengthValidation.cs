...
public static class FieldNameForInputLengthValidation
{
    ...
    public const string PrivateSectorFundingResult = "Private sector funding result";
    public const string PrivateSectorFundingReason = "Private sector funding not applying reason";
