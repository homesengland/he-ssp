...
public static class NotificationBody
{
    ...
    public const string ApplicationResubmitted = "Your application has now been submitted";

    public const string SectionCompletedAgain = "The section is now complete";
}
