...
public static class TaskListFields
{
    ...
    public const string ProvideDetailsAboutSecurity = "Provide details about security";

    public const string ProvideDetailsAboutFunding = "Provide details about funding";
}
