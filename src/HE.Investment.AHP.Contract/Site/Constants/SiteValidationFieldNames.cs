namespace HE.Investment.AHP.Contract.Site.Constants;
public static class SiteValidationFieldNames
{
    ...
    public const string Section106LocalAuthorityConfirmation = nameof(Section106LocalAuthorityConfirmation);
}
