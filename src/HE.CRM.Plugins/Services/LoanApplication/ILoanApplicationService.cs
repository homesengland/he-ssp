...
namespace HE.CRM.Plugins.Services.LoanApplication
{
    public interface ILoanApplicationService : ICrmService
    {
        ...
        string GetLoanApplicationsForAccountAndContact(string externalContactId, string accountId, string loanApplicationId = null, string fieldsToRetrieve = null);
        ...
        bool CheckIfLoanApplicationWithGivenNameExists(string loanName);
    }
}
