...
{
    public class PopulateFieldsOnCreateHandler : CrmEntityHandlerBase<invln_ISP, DataverseContext>
    {
        #region Fields
        ...
        {
            CrmServicesFactory.Get<IIspService>().PopulateFieldsOnCreate(target);
        }
