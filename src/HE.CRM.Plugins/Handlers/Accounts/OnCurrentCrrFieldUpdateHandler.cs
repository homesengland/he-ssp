...
{
    public class OnCurrentCrrFieldUpdateHandler : CrmEntityHandlerBase<Account, DataverseContext>
    {
        #region Fields
        ...
        {
            CrmServicesFactory.Get<IAccountService>().OnCurrentCrrFieldUpdate(target, preImage);
        }
