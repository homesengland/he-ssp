...
{
    public class CheckIfOwnerCanBeChangedHandler : CrmEntityHandlerBase<invln_Loanapplication, DataverseContext>
    {
        #region Fields
        ...
        {
            CrmServicesFactory.Get<ILoanApplicationService>().CheckIfOwnerCanBeChanged(target, preImage);
        }
