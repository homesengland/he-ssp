...
{
    public class SetFieldsWhenChangingStatusFromDraftHandler : CrmEntityHandlerBase<invln_Loanapplication, DataverseContext>
    {
        #region Fields
        ...
        {
            CrmServicesFactory.Get<ILoanApplicationService>().SetFieldsWhenChangingStatusFromDraft(target, preImage);
        }
