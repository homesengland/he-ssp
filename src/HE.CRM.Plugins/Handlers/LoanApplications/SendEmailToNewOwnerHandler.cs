...
{
    public class SendEmailToNewOwnerHandler : CrmEntityHandlerBase<invln_Loanapplication, DataverseContext>
    {
        #region Fields
        ...
        {
            CrmServicesFactory.Get<ILoanApplicationService>().SendEmailToNewOwner(target, preImage);
        }
