...
public class ShortGuidTests
{
    ...
    public void ShouldEncodeGuid(string guid, string expectedShortGuid)
    {
        // when
        var shortGuid = ShortGuid.FromGuid(new Guid(guid));
    ...
    [InlineData("1c87a928-c3cd-4ca7-8559-2918bb370ab4", "KKmHHM3Dp0yFWSkYuzcKtA")]
    [InlineData("56c2fb7a-d3f7-4e44-aa70-b6050ffb7cd7", "evvCVvfTRE6qcLYFD_t81w")]
    public void ShouldEncodeString(string guid, string expectedShortGuid)
    {
        // when
        var shortGuid = ShortGuid.FromString(guid);
