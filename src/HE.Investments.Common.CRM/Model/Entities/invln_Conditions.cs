...
namespace HE.Investments.Common.CRM.Model
{
	...
	public partial class invln_Conditions : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public partial class Fields
		{
			...
			public const string invln_conditionsourceName = "invln_conditionsourcename";
			public const string invln_ConditionStatus = "invln_conditionstatus";
			public const string invln_conditionstatusName = "invln_conditionstatusname";
			public const string invln_ConditionType = "invln_conditiontype";
			public const string invln_conditiontypeName = "invln_conditiontypename";
			...
			public const string invln_satisfactoryName = "invln_satisfactoryname";
			public const string invln_SatisfiedBy = "invln_satisfiedby";
			public const string invln_satisfiedbyName = "invln_satisfiedbyname";
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_conditionsourcename")]
		public string invln_conditionsourceName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_conditionsource"))
				{
					return this.FormattedValues["invln_conditionsource"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_conditionstatusname")]
		public string invln_conditionstatusName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_conditionstatus"))
				{
					return this.FormattedValues["invln_conditionstatus"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_conditiontypename")]
		public string invln_conditiontypeName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_conditiontype"))
				{
					return this.FormattedValues["invln_conditiontype"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_satisfactoryname")]
		public string invln_satisfactoryName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_satisfactory"))
				{
					return this.FormattedValues["invln_satisfactory"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_satisfiedbyname")]
		public string invln_satisfiedbyName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_satisfiedby"))
				{
					return this.FormattedValues["invln_satisfiedby"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_standardconditionname")]
		public string invln_StandardConditionName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_standardcondition"))
				{
					return this.FormattedValues["invln_standardcondition"];
				}
				else
				{
					return default(string);
		...
		public System.Collections.Generic.IEnumerable<HE.Investments.Common.CRM.Model.SharePointDocumentLocation> invln_conditions_SharePointDocumentLocations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<HE.Investments.Common.CRM.Model.SharePointDocumentLocation>("invln_conditions_SharePointDocumentLocations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_conditions_SharePointDocumentLocations");
				this.SetRelatedEntities<HE.Investments.Common.CRM.Model.SharePointDocumentLocation>("invln_conditions_SharePointDocumentLocations", null, value);
		...
		public HE.Investments.Common.CRM.Model.invln_Loanapplication invln_Conditions_invln_Loanapplication_in
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.invln_Loanapplication>("invln_Conditions_invln_Loanapplication_in", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_Conditions_invln_Loanapplication_in");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.invln_Loanapplication>("invln_Conditions_invln_Loanapplication_in", null, value);
		...
		public HE.Investments.Common.CRM.Model.invln_StandardCondition invln_invln_conditions_StandardCondition_invln_
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.invln_StandardCondition>("invln_invln_conditions_StandardCondition_invln_", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_invln_conditions_StandardCondition_invln_");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.invln_StandardCondition>("invln_invln_conditions_StandardCondition_invln_", null, value);
		...
		public HE.Investments.Common.CRM.Model.invln_ISP invln_invln_isp_invln_conditions_ispid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.invln_ISP>("invln_invln_isp_invln_conditions_ispid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_invln_isp_invln_conditions_ispid");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.invln_ISP>("invln_invln_isp_invln_conditions_ispid", null, value);
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_conditions_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_conditions_createdby", null);
			}
		}
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_conditions_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_conditions_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_invln_conditions_createdonbehalfby");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_conditions_createdonbehalfby", null, value);
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_conditions_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_conditions_modifiedby", null);
			}
		}
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_conditions_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_conditions_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_invln_conditions_modifiedonbehalfby");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_conditions_modifiedonbehalfby", null, value);
		...
		public HE.Investments.Common.CRM.Model.Team team_invln_conditions
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.Team>("team_invln_conditions", null);
			}
		}
		...
		public HE.Investments.Common.CRM.Model.SystemUser user_invln_conditions
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("user_invln_conditions", null);
			}
		}
