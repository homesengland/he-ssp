...
namespace HE.Investments.Common.CRM.Model
{
	...
	public partial class invln_notificationsetting : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<HE.Investments.Common.CRM.Model.invln_govnotifyemail> invln_notificationsetting_invln_govnotifyemail_emailtemplate
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<HE.Investments.Common.CRM.Model.invln_govnotifyemail>("invln_notificationsetting_invln_govnotifyemail_emailtemplate", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_notificationsetting_invln_govnotifyemail_emailtemplate");
				this.SetRelatedEntities<HE.Investments.Common.CRM.Model.invln_govnotifyemail>("invln_notificationsetting_invln_govnotifyemail_emailtemplate", null, value);
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_notificationsetting_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_notificationsetting_createdby", null);
			}
		}
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_notificationsetting_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_notificationsetting_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_invln_notificationsetting_createdonbehalfby");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_notificationsetting_createdonbehalfby", null, value);
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_notificationsetting_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_notificationsetting_modifiedby", null);
			}
		}
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_notificationsetting_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_notificationsetting_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_invln_notificationsetting_modifiedonbehalfby");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_notificationsetting_modifiedonbehalfby", null, value);
				this.OnPropertyChanged("lk_invln_notificationsetting_modifiedonbehalfby");
			}
		}
		
		/// <summary>
		/// N:1 team_invln_notificationsetting
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("owningteam")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("team_invln_notificationsetting")]
		public HE.Investments.Common.CRM.Model.Team team_invln_notificationsetting
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.Team>("team_invln_notificationsetting", null);
			}
		}
		...
		public HE.Investments.Common.CRM.Model.SystemUser user_invln_notificationsetting
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("user_invln_notificationsetting", null);
			}
		}
