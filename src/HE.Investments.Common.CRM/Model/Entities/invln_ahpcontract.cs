...
namespace HE.Investments.Common.CRM.Model
{
	...
	public partial class invln_ahpcontract : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public partial class Fields
		{
			...
			public const string invln_compliantnoncompliantName = "invln_compliantnoncompliantname";
			public const string invln_ConsortiumSingleentity = "invln_consortiumsingleentity";
			public const string invln_consortiumsingleentityName = "invln_consortiumsingleentityname";
			public const string invln_ContractDraftedby = "invln_contractdraftedby";
			public const string invln_ContractDraftedbyName = "invln_contractdraftedbyname";
			public const string invln_ContractDraftedbyYomiName = "invln_contractdraftedbyyominame";
			public const string invln_ContractLead = "invln_contractlead";
			public const string invln_ContractLeadName = "invln_contractleadname";
			public const string invln_ContractLeadYomiName = "invln_contractleadyominame";
			...
			public const string invln_contractversionName = "invln_contractversionname";
			public const string invln_DateContractIssued = "invln_datecontractissued";
			...
			public const string invln_powerofattorneypreviouslyusedName = "invln_powerofattorneypreviouslyusedname";
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_ahpapplicationname")]
		public string invln_AHPApplicationName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_ahpapplication"))
				{
					return this.FormattedValues["invln_ahpapplication"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_compliantnoncompliantname")]
		public string invln_compliantnoncompliantName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_compliantnoncompliant"))
				{
					return this.FormattedValues["invln_compliantnoncompliant"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_consortiumsingleentityname")]
		public string invln_consortiumsingleentityName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_consortiumsingleentity"))
				{
					return this.FormattedValues["invln_consortiumsingleentity"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_contractdraftedby")]
		public Microsoft.Xrm.Sdk.EntityReference invln_ContractDraftedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("invln_contractdraftedby");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ContractDraftedby");
				this.SetAttributeValue("invln_contractdraftedby", value);
				this.OnPropertyChanged("invln_ContractDraftedby");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_contractdraftedbyname")]
		public string invln_ContractDraftedbyName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_contractdraftedby"))
				{
					return this.FormattedValues["invln_contractdraftedby"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_contractdraftedbyyominame")]
		public string invln_ContractDraftedbyYomiName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_contractlead")]
		public Microsoft.Xrm.Sdk.EntityReference invln_ContractLead
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("invln_contractlead");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ContractLead");
				this.SetAttributeValue("invln_contractlead", value);
				this.OnPropertyChanged("invln_ContractLead");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_contractleadname")]
		public string invln_ContractLeadName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_contractlead"))
				{
					return this.FormattedValues["invln_contractlead"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_contractleadyominame")]
		public string invln_ContractLeadYomiName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_contractversionname")]
		public string invln_contractversionName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_contractversion"))
				{
					return this.FormattedValues["invln_contractversion"];
				}
				else
				{
					return default(string);
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_datecontractissued")]
		public System.Nullable<System.DateTime> invln_DateContractIssued
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("invln_datecontractissued");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_DateContractIssued");
				this.SetAttributeValue("invln_datecontractissued", value);
				this.OnPropertyChanged("invln_DateContractIssued");
			}
		}
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_powerofattorneypreviouslyusedname")]
		public string invln_powerofattorneypreviouslyusedName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("invln_powerofattorneypreviouslyused"))
				{
					return this.FormattedValues["invln_powerofattorneypreviouslyused"];
				}
				else
				{
					return default(string);
		...
		/// <summary>
		/// 1:N invln_ahpcontract_SharePointDocumentLocations
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("invln_ahpcontract_SharePointDocumentLocations")]
		public System.Collections.Generic.IEnumerable<HE.Investments.Common.CRM.Model.SharePointDocumentLocation> invln_ahpcontract_SharePointDocumentLocations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<HE.Investments.Common.CRM.Model.SharePointDocumentLocation>("invln_ahpcontract_SharePointDocumentLocations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ahpcontract_SharePointDocumentLocations");
				this.SetRelatedEntities<HE.Investments.Common.CRM.Model.SharePointDocumentLocation>("invln_ahpcontract_SharePointDocumentLocations", null, value);
		...
		public HE.Investments.Common.CRM.Model.invln_scheme invln_ahpcontract_AHPApplication_invln_scheme
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.invln_scheme>("invln_ahpcontract_AHPApplication_invln_scheme", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ahpcontract_AHPApplication_invln_scheme");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.invln_scheme>("invln_ahpcontract_AHPApplication_invln_scheme", null, value);
				this.OnPropertyChanged("invln_ahpcontract_AHPApplication_invln_scheme");
			}
		}
		
		/// <summary>
		/// N:1 invln_ahpcontract_ContractDraftedby_team
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_contractdraftedby")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("invln_ahpcontract_ContractDraftedby_team")]
		public HE.Investments.Common.CRM.Model.Team invln_ahpcontract_ContractDraftedby_team
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.Team>("invln_ahpcontract_ContractDraftedby_team", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ahpcontract_ContractDraftedby_team");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.Team>("invln_ahpcontract_ContractDraftedby_team", null, value);
				this.OnPropertyChanged("invln_ahpcontract_ContractDraftedby_team");
			}
		}
		
		/// <summary>
		/// N:1 invln_ahpcontract_ContractLead_systemuser
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("invln_contractlead")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("invln_ahpcontract_ContractLead_systemuser")]
		public HE.Investments.Common.CRM.Model.SystemUser invln_ahpcontract_ContractLead_systemuser
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("invln_ahpcontract_ContractLead_systemuser", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ahpcontract_ContractLead_systemuser");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("invln_ahpcontract_ContractLead_systemuser", null, value);
		...
		public HE.Investments.Common.CRM.Model.Account invln_ahpcontract_Partner_account
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.Account>("invln_ahpcontract_Partner_account", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ahpcontract_Partner_account");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.Account>("invln_ahpcontract_Partner_account", null, value);
		...
		public HE.Investments.Common.CRM.Model.invln_programme invln_ahpcontract_Programme_invln_programme
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.invln_programme>("invln_ahpcontract_Programme_invln_programme", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ahpcontract_Programme_invln_programme");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.invln_programme>("invln_ahpcontract_Programme_invln_programme", null, value);
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_ahpcontract_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_ahpcontract_createdby", null);
			}
		}
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_ahpcontract_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_ahpcontract_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_invln_ahpcontract_createdonbehalfby");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_ahpcontract_createdonbehalfby", null, value);
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_ahpcontract_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_ahpcontract_modifiedby", null);
			}
		}
		...
		public HE.Investments.Common.CRM.Model.SystemUser lk_invln_ahpcontract_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_ahpcontract_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_invln_ahpcontract_modifiedonbehalfby");
				this.SetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("lk_invln_ahpcontract_modifiedonbehalfby", null, value);
		...
		public HE.Investments.Common.CRM.Model.Team team_invln_ahpcontract
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.Team>("team_invln_ahpcontract", null);
			}
		}
		...
		public HE.Investments.Common.CRM.Model.SystemUser user_invln_ahpcontract
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<HE.Investments.Common.CRM.Model.SystemUser>("user_invln_ahpcontract", null);
			}
		}
