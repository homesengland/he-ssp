...
namespace HE.CRM.Common.Repositories.Implementations
{
    public class AhpApplicationRepository : CrmEntityRepository<invln_scheme, DataverseContext>, IAhpApplicationRepository
    {
        ...
        public List<invln_scheme> GetRecordsFromAhpApplicationsForAhpProject(Guid ahpProjectGuid, invln_Permission contactWebRole, Contact contact, Guid organisationGuid, bool isLeadPartner, bool IsSitePartner, bool isAllocation, bool useV2Version, string consortiumId = null)
        {
        ...
        public EntityCollection GetAllocationWithDeliveryPhaseAndClaims(string externalContactId, Guid accountId, Guid allocationId, Guid deliveryPhaseId)
        {
            ...
            string[] listOfDeliveryPhaseColumns = {
            ...
            DeliveryPhase.Columns.AddColumns(listOfDeliveryPhaseColumns);
            ...
            ClaimAcquisition.Columns.AddColumns(listOfClaimColumns);
            ...
            ClaimSoS.Columns.AddColumns(listOfClaimColumns);
            ...
            ClaimPC.Columns.AddColumns(listOfClaimColumns);
