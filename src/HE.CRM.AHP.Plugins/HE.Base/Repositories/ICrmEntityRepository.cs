...
namespace HE.Base.Repositories
{
        ...
        where TContext : OrganizationServiceContext
    {
        ...
        bool Update(Entity entityToUpdate, Entity entityOriginal);
    ...
    public interface ICrmEntityRepository : ICrmRepository
    {
        ...
        bool UpdateAttributeIfValueChanged(EntityReference entityReference, string attributeName, object value);
