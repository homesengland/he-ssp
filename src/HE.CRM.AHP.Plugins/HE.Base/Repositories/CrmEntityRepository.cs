...
using HE.Base.Common.Constants;
using System;
...
namespace HE.Base.Repositories
{
    ...
    /// <seealso cref="ICrmEntityRepository" />
        ...
        where TContext : OrganizationServiceContext
    {
        ...
        public bool Update(Entity entityToUpdate, Entity entityOriginal)
        {
            using (TraceExecution(entityToUpdate))
            {
                return entityToUpdate.UpdateIfDirty(entityOriginal, service);
            }
        }
    ...
    public class CrmEntityRepository : CrmRepository, ICrmEntityRepository
    {
        ...
        public bool UpdateAttributeIfValueChanged(EntityReference entityReference, string attributeName, object value)
        {
            var originalEntity = GetById(entityReference, attributeName);
            var copy = originalEntity.Clone<Entity>();

            copy.SetAttribute(attributeName, value);

            return copy.UpdateIfDirty(originalEntity, service);
