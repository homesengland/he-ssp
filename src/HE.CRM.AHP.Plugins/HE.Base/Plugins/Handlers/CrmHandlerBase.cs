...
namespace HE.Base.Plugins.Handlers
{
    ...
    public abstract class CrmHandlerBase<TContext> : ICrmHandler where TContext : OrganizationServiceContext
    {
        ...
        protected IBaseLogger Logger { get; private set; }
        ...
        /// <param name="cache">Handlers cache which can distribute cached data in execution pipeline.</param>
        public virtual void Initialize(IServiceProvider serviceProvider, ICrmRepositoriesFactory crmRepositoriesFactory, ICrmServicesFactory servicesFactory, IBaseLogger logger, HandlerCache cache)
        {
