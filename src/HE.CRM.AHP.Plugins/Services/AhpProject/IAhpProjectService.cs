...
namespace HE.CRM.AHP.Plugins.Services.AhpProject
{
    public interface IAhpProjectService : ICrmService
    {
        ...
        AhpProjectDto GetAhpProjectWithApplicationsAndSitesAndAlloctions(string externalContactId, string organisationId, string ahpProjectId, string heProjectId, string consortiumId);
