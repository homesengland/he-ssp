...
namespace HE.CRM.AHP.Plugins.Services.DeliveryPhase
{
    public interface IDeliveryPhaseService : ICrmService
    {
        ...
        void CalculateFunding(invln_scheme application, invln_DeliveryPhase deliveryPhaseMapped, List<invln_milestoneframeworkitem> milestones, bool resetMilestone, invln_DeliveryPhase deliveryPhaseToUpdateOrCreate);
