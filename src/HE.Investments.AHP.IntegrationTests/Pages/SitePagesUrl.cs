...
public static class SitePagesUrl
{
    ...
    public static string SiteDevelopingPartner(string siteId) => $"ahp/site-partners/{siteId}/developing-partner";

    public static string SiteDevelopingPartnerConfirmation(string siteId, string organisationId) => $"ahp/site-partners/{siteId}/developing-partner-confirm/{organisationId}";

    public static string SiteOwnerOfTheLand(string siteId) => $"ahp/site-partners/{siteId}/owner-of-the-land";

    public static string SiteOwnerOfTheLandConfirmation(string siteId, string organisationId) => $"ahp/site-partners/{siteId}/owner-of-the-land-confirm/{organisationId}";

    public static string SiteOwnerOfTheHomes(string siteId) => $"ahp/site-partners/{siteId}/owner-of-the-homes";

    public static string SiteOwnerOfTheHomesConfirmation(string siteId, string organisationId) => $"ahp/site-partners/{siteId}/owner-of-the-homes-confirm/{organisationId}";
