...
namespace DataverseModel
{
	...
	public partial class invln_ahpcontract : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<DataverseModel.SharePointDocumentLocation> invln_ahpcontract_SharePointDocumentLocations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.SharePointDocumentLocation>("invln_ahpcontract_SharePointDocumentLocations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ahpcontract_SharePointDocumentLocations");
				this.SetRelatedEntities<DataverseModel.SharePointDocumentLocation>("invln_ahpcontract_SharePointDocumentLocations", null, value);
		...
		public DataverseModel.Team invln_ahpcontract_ContractDraftedby_team
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataverseModel.Team>("invln_ahpcontract_ContractDraftedby_team", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ahpcontract_ContractDraftedby_team");
				this.SetRelatedEntity<DataverseModel.Team>("invln_ahpcontract_ContractDraftedby_team", null, value);
		...
		public DataverseModel.SystemUser invln_ahpcontract_ContractLead_systemuser
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DataverseModel.SystemUser>("invln_ahpcontract_ContractLead_systemuser", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ahpcontract_ContractLead_systemuser");
				this.SetRelatedEntity<DataverseModel.SystemUser>("invln_ahpcontract_ContractLead_systemuser", null, value);
