...
namespace DataverseModel
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<DataverseModel.invln_Externalcomms> contact_invln_Externalcommses
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.invln_Externalcomms>("contact_invln_Externalcommses", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("contact_invln_Externalcommses");
				this.SetRelatedEntities<DataverseModel.invln_Externalcomms>("contact_invln_Externalcommses", null, value);
		...
		public System.Collections.Generic.IEnumerable<DataverseModel.invln_govnotifyemail> contact_invln_govnotifyemails
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.invln_govnotifyemail>("contact_invln_govnotifyemails", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("contact_invln_govnotifyemails");
				this.SetRelatedEntities<DataverseModel.invln_govnotifyemail>("contact_invln_govnotifyemails", null, value);
		...
		public System.Collections.Generic.IEnumerable<DataverseModel.invln_Loanapplication> invln_contact_invln_loanapplication_contactid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.invln_Loanapplication>("invln_contact_invln_loanapplication_contactid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_contact_invln_loanapplication_contactid");
				this.SetRelatedEntities<DataverseModel.invln_Loanapplication>("invln_contact_invln_loanapplication_contactid", null, value);
		...
		public System.Collections.Generic.IEnumerable<DataverseModel.invln_scheme> invln_contact_invln_scheme_lastexternalmodificationby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.invln_scheme>("invln_contact_invln_scheme_lastexternalmodificationby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
