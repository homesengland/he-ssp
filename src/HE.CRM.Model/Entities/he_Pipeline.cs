...
///(FT /Non FT Spend Mix)
		...
		public System.Collections.Generic.IEnumerable<DataverseModel.invln_ahpproject> invln_ahpproject_HeProjectId_he_pipeline
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DataverseModel.invln_ahpproject>("invln_ahpproject_HeProjectId_he_pipeline", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("invln_ahpproject_HeProjectId_he_pipeline");
				this.SetRelatedEntities<DataverseModel.invln_ahpproject>("invln_ahpproject_HeProjectId_he_pipeline", null, value);
