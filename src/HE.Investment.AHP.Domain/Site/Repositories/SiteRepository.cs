...
public class SiteRepository : ISiteRepository
{
    ...
    private static IList<SiteEntity> MockedSiteEntities()
    {
        ...
        {
            new(new SiteId("1"), new SiteName("Mocked Site 1"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities(), new LocalAuthority(new LocalAuthorityId("1"), "local auth")),
            new(new SiteId("2"), new SiteName("Mocked Site Carquinez"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities()),
            new(new SiteId("3"), new SiteName("Mocked Site JJ"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities()),
            new(new SiteId("4"), new SiteName("Mocked Site Antonios"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities(), new LocalAuthority(new LocalAuthorityId("4"), "local auth")),
            new(new SiteId("5"), new SiteName("Mocked Site 5"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities()),
            new(new SiteId("6"), new SiteName("Mocked Site Dawidex"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities(), new LocalAuthority(new LocalAuthorityId("6"), "local auth")),
            new(new SiteId("7"), new SiteName("Mocked Site 7"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities()),
            new(new SiteId("8"), new SiteName("Mocked Site Rafus"), new Section106(true, false, null, null, null, null), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities()),
            new(new SiteId("9"), new SiteName("Mocked Site 9"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities()),
            new(new SiteId("10"), new SiteName("Mocked Site 2 10"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities()),
            new(new SiteId("11"), new SiteName("Mocked Site 2 1"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities()),
            ...
            new(new SiteId("19"), new SiteName("Mocked Site 2 9"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities(), new LocalAuthority(new LocalAuthorityId("19"), "local auth")),
            new(new SiteId("20"), new SiteName("Mocked Site 2 10"), new Section106(), PlanningDetailsFactory.CreateEmpty(), new NationalDesignGuidePriorities()),
        };
    }
}
