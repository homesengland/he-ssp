...
public class SiteCrmContext : ISiteCrmContext
{
    private static readonly string SiteCrmFields =
        string.Join(
                ...
                nameof(invln_Sites.invln_HeLocalAuthorityId),
                nameof(invln_Sites.invln_HeLocalAuthorityIdName),
                ...
                nameof(invln_Sites.invln_developingpartner),
                nameof(invln_Sites.invln_ownerofthelandduringdevelopment),
                nameof(invln_Sites.invln_Ownerofthehomesaftercompletion),
