...
public interface IApplicationCrmContext
{
    ...
    Task<IList<AhpApplicationDto>> GetSiteApplications(string siteId, string organisationId, string userId, string? consortiumId, CancellationToken cancellationToken);
