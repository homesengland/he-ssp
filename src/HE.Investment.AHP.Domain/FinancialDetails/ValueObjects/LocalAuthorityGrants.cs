...
public class LocalAuthorityGrants : ValueObject
{
    public LocalAuthorityGrants(string value)
    {
        ...
        var intValue = NumericValidator
            .For(value, FinancialDetailsValidationFieldNames.LocalAuthorityGrants, operationResult)
    ...
    public static LocalAuthorityGrants? From(decimal? value)
    {
        ...
        return new LocalAuthorityGrants(value.ToWholeNumberString() ?? string.Empty);
    }
