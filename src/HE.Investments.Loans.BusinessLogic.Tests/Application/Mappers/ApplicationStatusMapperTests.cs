...
public class ApplicationStatusMapperTests
{
    ...
    [DataRow(ApplicationStatus.AwaitingCpSatisfaction, 858110015)]
    [DataRow(ApplicationStatus.ConditionsSatisfied, 858110016)]
    ...
    [DataRow(858110015, ApplicationStatus.AwaitingCpSatisfaction)]
    [DataRow(858110016, ApplicationStatus.ConditionsSatisfied)]
