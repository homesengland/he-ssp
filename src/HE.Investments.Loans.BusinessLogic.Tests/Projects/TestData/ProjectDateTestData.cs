...
internal static class ProjectDateTestData
{
    ...
    public static readonly (string Year, string Month, string Day) OtherCorrectDateAsStrings = DateTimeTestData.OtherCorrectDateAsStrings;

    public static readonly DateTime CorrectDateTime = new(2022, 1, 31, 0, 0, 0, DateTimeKind.Unspecified);

    public static readonly DateTime OtherCorrectDate = new(2022, 3, 31, 0, 0, 0, DateTimeKind.Unspecified);
}
