...
{
    [TestClass]
    public class InviteContactToJoinExistingOrganisationPluginTests
    {
        ...
        public void Test_1()
        {
            ...
            try
            {
                fakedContext.ExecutePluginWithConfigurations<InviteContactToJoinExistingOrganisationPlugin>(pluginContext, "", "");
            }
            catch (Exception e)
            {
