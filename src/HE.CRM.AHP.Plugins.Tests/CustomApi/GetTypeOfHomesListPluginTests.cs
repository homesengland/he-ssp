...
namespace HE.CRM.AHP.Plugins.Tests.CustomApi
{
    ...
    public class GetTypeOfHomesListPluginTests
    {
        ...
        [TestMethod]
        public void GetTypeOfHomesListPluginTestSucces()
        {
            ...
            fakedContext.Initialize(new List<Entity>()
            {
                ...
                },
                {
                    new invln_scheme()
                    {
                        Id = appId, invln_organisationid = organizationId.ToEntityReference<Account>(),
            ...
            Assert.AreEqual(homeTypeId.ToString(), JsonSerializer.Deserialize<List<HomeTypeDto>>(outputResponce).FirstOrDefault().id);
        }
    }
}
