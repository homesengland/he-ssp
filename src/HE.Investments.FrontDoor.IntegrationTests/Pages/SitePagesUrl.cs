...
internal static class SitePagesUrl
{
    ...
    public static string LocalAuthorityConfirm(string projectId, string siteId, string localAuthorityCode) => BuildSitePage(projectId, siteId, $"local-authority-confirm?localauthorityid={localAuthorityCode}");
